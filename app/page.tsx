...
export default function Home() {
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr,2px,2fr,1fr] gap-4 items-center">
          {/* <div className="flex justify-between mb-4"> */}
            ...
            <div>
              ...
              <p className="font-bold text-green-500">16.6%</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">30day Volume</p>
              <p className="font-bold">$132,000</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Pairs</p>
              <p className="font-bold">SOL/USD, TIA/USD</p>
            </div>
        </div>
      ...
      <Card className="mb-8 bg-white text-black shadow-lg blur-sm">
      <CardContent className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-[1fr,2px,2fr,1fr] gap-4 items-center">
          {/* <div className="flex justify-between mb-4"> */}
            <div>
